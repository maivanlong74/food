...
<body>
	...
	<div class="form">
		<label style="margin-left: 198px; margin-top: 6px; display: block;">Đăng nhập admin</label>
		<form action="dangnhapadminController" method="post" class="dangnhap">
			...
			<input name="but1" type="submit" value="Login" Style="margin-left: 160px; width: 88px; padding-top: 5px; margin-top: 15px;"><br>
				<%if(request.getParameter("kt")!=null){
		    	  out.print("<script>alert('Bạn không có phận sự miễn vào');</script>");
		      }
    	  %>
		</form>
	</div>
	<h1
		style="width: 373px; margin-left: 822px; margin-top: -24px; display: block; font-weight: bold;">Nhà
		Sách Long Long</h1>
